...
public class LaserEnemy : MonoBehaviour {
    ...
    public void basicEnemyLaser()
    {
        EnemyLaserProjectileController laser = LaserbeamProjectile.GetComponent<EnemyLaserProjectileController>();
        laser.damage = damage;
        if (player.transform.position.x > transform.position.x)
        {
            laser.velocityX = 3;

...
public class SniperEnemy : MonoBehaviour
{
    ...
    public void basicEnemySniper()
    {
        checkFacing();
        EnemyPenetrateBulletController bullet = PenetrateBullet.GetComponent<EnemyPenetrateBulletController>();
